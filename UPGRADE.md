...
## Next — adopting the enforcement `init` now writes
...
## Next — declaring who calls you over stdio
...
## Next — the CLI stopped printing `mcp_server`
...
## Next — a config generated by an older `init`
