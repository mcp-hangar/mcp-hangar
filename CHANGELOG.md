...
## [1.6.1](https://github.com/mcp-hangar/mcp-hangar/compare/v2.0.1...v1.6.1) (2026-07-31)
...
* **security:** re-establish approval validity at dispatch, not only at decision ([#673](https://github.com/mcp-hangar/mcp-hangar/issues/673)) ([85f549e](https://github.com/mcp-hangar/mcp-hangar/commit/85f549e9e548006d1347d400eab6d70ca11fbbbc))
...
A single security fix. Behaviour changes in one direction only: a call whose world moved while its approval was pending is now refused where it previously executed.
