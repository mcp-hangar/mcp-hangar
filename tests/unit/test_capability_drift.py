...
and that ProviderRecoverySaga correctly filters capability_violation events.
"""

import pytest

from mcp_hangar.domain.events import CapabilityViolationDetected, ProviderDegraded, ProviderStateChanged
...
class TestVerifyCapabilityDrift:
    ...
    def test_undeclared_tools_block_mode_goes_dead(self) -> None:
        ...
        # Should also have a ProviderStateChanged event for READY -> DEAD
        state_events = [e for e in events if isinstance(e, ProviderStateChanged)]
...
class TestRecoverySagaCapabilityFilter:
    """Tests for ProviderRecoverySaga filtering of capability_violation events."""
    ...
    def test_saga_proceeds_for_normal_degraded(self) -> None:
        ...
        _handle_degraded() always returns [] but schedules a StartProviderCommand
