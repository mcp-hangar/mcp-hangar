...
def otel_setup():
    ...
    import mcp_hangar.application.services.traced_mcp_server_service as tps_mod
...
class TestOtelSpanAttributesIntegration:
    ...
    def test_tool_invoke_span_has_correct_name(self, otel_setup) -> None:
        ...
        svc = TracedMcpServerService(mcp_server_service=mock_inner, observability=NullObservabilityAdapter())
    ...
    def test_tool_invoke_span_has_mcp_server_id(self, otel_setup) -> None:
        ...
        assert tool_span.attributes.get(McpServer.ID) == "my-provider"
