...
class SQLiteKnowledgeBase(IKnowledgeBase):
    ...
    async def initialize(self) -> bool:
        ...
        except Exception as e:  # noqa: BLE001 -- infra-boundary: returns False on any init failure
    ...
    async def cache_get(self, provider: str, tool: str, arguments: dict) -> dict | None:
        ...
        try:
            async with (
                ...
                return None
        except Exception as e:  # noqa: BLE001 -- infra-boundary: graceful degradation, returns fallback on DB error
